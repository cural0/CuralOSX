...
public:
    ...
    const char* GetModelName(const char *model)
    {
        typedef const char* (* oGetModelName)(void*, const char*);
        return getvfunc<oGetModelName>(this, 4)(this, model);
    }
    
    void GetModelMaterials(const char *model, int count, IMaterial** ppMaterial)
    {
        typedef studiohdr_t* (* oGetModelMaterials)(void*, const char*, int, IMaterial**);
