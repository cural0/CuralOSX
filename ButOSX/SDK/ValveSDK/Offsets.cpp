...
void Offsets::getOffsets()
{
    ...
    offsets.DT_BasePlayer.m_bDormant = NetVarManager::getOffset(tables, "DT_BasePlayer", "m_bDormant");
    ...
    offsets.DT_CSPlayerResource.m_bombsiteCenterA = NetVarManager::getOffset(tables, "DT_CSPlayerResource", "m_bombsiteCenterA");
    ...
    offsets.DT_PlantedC4.m_flC4Blow = NetVarManager::getOffset(tables, "DT_PlantedC4", "m_flTimerLength");
