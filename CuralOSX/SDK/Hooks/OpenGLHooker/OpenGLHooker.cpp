...
void InitImGui(SDL_Window* window){
    ...
    if(!LoadBytes){
        ...
        g_Font2 = ImGui::GetIO().Fonts->AddFontFromMemoryCompressedTTF(mysego_compressed_data, mysego_compressed_size, 15.f, nullptr, uiIO.Fonts->GetGlyphRangesCyrillic());
        ...
        g_CSGOICONS = ImGui::GetIO().Fonts->AddFontFromMemoryCompressedTTF(CStrike_compressed_data, CStrike_compressed_size, 50.0f, nullptr, uiIO.Fonts->GetGlyphRangesCyrillic());
        LoadBytes = true;
    }
    IMGUI_CHECKVERSION();
